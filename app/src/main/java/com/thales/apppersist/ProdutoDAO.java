...
public class ProdutoDAO {
    ...
    public static void inserir(Context context, Produto produto){
        ...
        values.put("categoria", produto.getNome());
    ...
    public static List<Produto> getProdutos(Context context){
        ...
        Cursor cursor = db.rawQuery("SELECT nome, categoria FROM produtos ORDER BY nome", null);
    ...
    public static Produto getProdutoById(Context context, int idProduto){
        ...
        Cursor cursor = db.rawQuery("SELECT nome, categoria FROM produtos WHERE id = " + idProduto, null);
